...
- $b_0$: the "Intercept". This is the predicted value of $y$ where $x = 0$.
...
- $b_1$: the "Coefficient for $x$". This is the predicted *increase* in $y$ for every unit increase of $x$.  
...
We also saw how this same logic applies when categorical explanatory variables are involved in an interaction, as in Figure \@ref(fig:catintglm) 

```{r catintglm, echo=FALSE, fig.cap="https://uoepsy.github.io/usmr/lectures/lecture_8#58"}
