...
:::qq
__Q2:__  Read in the data, and calculate the overall daytime functioning score, following the criteria outlined above. Make this a new column in your dataset.
...
:::
:::qq
__Q3:__ Calculate the correlation between the total sleep time (`TST`) and the overall daytime functioning score calculated in the previous question.  
...
:::qq
__Q4 (open-ended):__ Think about this relationship in terms of _causation_.  
<br>
...
:::qq
__Q5:__  The Scottish National Gallery kindly provided us with measurements of side and perimeter (in metres) for a sample of 10 square paintings.
...
:::qq
__Q6:__  Use our mathematical model to predict the perimeter of a painting with a side of 1.5 metres.  
...
:::qq
__Q7:__ Consider the relationship between height (in inches) and handspan (in cm).  
