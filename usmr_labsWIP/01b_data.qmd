...
Thinking back to Section 1A when we first introduced R, we [talked briefly about "logical operators"](01a_R.html#R_is_a_calculator){target="_blank"}. Specifically, the operators `&`, `|`, and `!` (for "and", "or"," and "not"), will come in handy now.  
