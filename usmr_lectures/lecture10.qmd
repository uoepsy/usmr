...
# Zen and the Art of Stats {background-color="#FCBB06" style="text-align: center;"}
...
# [The Bits We Didn't Talk About]{.r-fit-text background-color="#FCBB06" style="text-align: center;"}
...
# Reaching Nirv-R-na {background-color="#FCBB06" style="text-align: center;" background-image="img/nirvana.png" background-size="contain"}

![](img/blank.png){fig-align="center"}

## Three Basic Rules for Survival

### 1. someone's done it before

- google is your friend

- often good answers on [stackexchange](https://stackexchange.com)




## 2. someone's written about it
