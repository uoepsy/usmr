...
**Lectures**<br/>
core orientation to topics

![](img/readings.png){width=60px}

**Readings/Walkthroughs**<br/>
you're encouraged to work through these
...
**due** the following Friday at 12:00

**quizzes should be taken individually**
:::

## Group Project (65%) {auto-animate=true}
...
::: {.myblock .fragment fragment-index=1 data-id="box"}
**released** Thursday 6 November

**due** Thursday 11 December at 12:00
...
::: {.myblock data-id="box"}
**released** Thursday 12 November

**due** Thursday 10 December at 12:00

**each lab group should produce _one_ report (with code)**
:::

- this deadline is _extended by a week_ to include any allowances that individual students might have

- by **mainstreaming** the adjustment we can ensure that things are fair for all groups
