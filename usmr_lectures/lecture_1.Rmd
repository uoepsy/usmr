---
title: "<b>Week 1: Introductions to R and Statistics</b>"
...
knitr::include_graphics('lecture_1_files/img/dapr-intro-book.png')
```
...
```{r echo=F, out.width='75%', fig.align='center'}
knitr::include_graphics('lecture_1_files/img/dapr-intro-website.png')
```
...
```{r echo=F, out.width='75%', fig.align='center'}
knitr::include_graphics('lecture_1_files/img/dapr-intro-plot.png')
```
...
```{r echo=F, out.width='75%', fig.align='center'}
knitr::include_graphics('lecture_1_files/img/dapr-intro-dash.png')
```
