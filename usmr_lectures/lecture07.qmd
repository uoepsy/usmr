...
## Course Assignment {background-color="#FFA5A5" visibility="uncounted"}

- released on Thursday, due Thu 14 December

- all the info you need should be on Learn

- any questions? → Piazza

![](img/playmo_investors-removebg-preview.png){fig-align="right"}
