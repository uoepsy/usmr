...
:::: myblock
if we measure the mean height of `r length(uheights)` people from the same population as the USMR class, we are 95% confident that the population mean lies between `r .rround(mean(uheights)-1.96*se,1)`cm and `r .rround(mean(uheights)+1.96*se,1)`cm
::::
