...
## Lab Groups from Week 3

<iframe data-external="1" allowfullscreen frameborder="0" height="100%" mozallowfullscreen style="min-width: 600px; min-height: 450px" src="https://app.wooclap.com/events/DUABROC/questions/6ab3d715801e260660160284" width="100%"></iframe>
...
## The Standard Normal Curve {#snorm}
...
- we know that 95% of our best estimates will fall [within ±1.96 standard errors](#snorm) of the sample mean
...
survey <- read_csv('https://uoepsy.github.io/data/usmr26survey_historical.csv') |> select(course,height) |> drop_na()
