...
- so far we've been sampling from a _known_ population (because we made the population!)

  - we know the mean and sd of the population

- in real experiments, the (parameters of) the population are _unknown_
