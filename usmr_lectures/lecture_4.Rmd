...
- here are the eyecolours returned for USMR (two ways)
...
assume chance govern's Muriel's judgements
]
]]

???
- there are some problems with Fisher's reputation and I don't think we should celebrate him.  However there are millions of textbooks which refer to the test this way, as does R
---
# Combinations
...
- we know that in general, larger numbers give us better estimates of things, but can we say any more about this?

- back to throwing a die
---
...
# Part 3:  The Zen of Stats

.center[
![:scale 70%](lecture_4_files/img/zen.png)
]
