...
- USMR is created in **RStudio**, using **R** and **Quarto**
...
- OK to ask for help
  ...
  - "what's the command for a t test?"
  
  - "how do I change this colour?"
  
  - "does this look right to you?"

- **not OK** to shirk work

  - "what's the answer to question 3?"
  
  - "can I copy your intro?"


:::

::: {.column width="40%"}
![](img/ai_policy1.jpg){width="90%"}
:::

::::

::: {.myblock style="text-align: center;"}
don't use anyone else to do your thinking for you
:::
...
::: {.column width="40%"}
![](img/ai_policy2.jpg){width="90%"}
:::

::::

::: {.myyellowblock style="text-align: center;"}
don't use any*thing* else to do your thinking for you
:::
