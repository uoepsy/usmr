...
:::hints
_The best way to learn R is to use it. Try following along with these readings by typing the code into your R script and running them. You will hopefully get the same output as is presented on this page below each bit of code. If you get errors and warnings, don't panic - read them!_  
:::
...
After you've changed them, take a 5 minute break before moving on to the next chapter.  
