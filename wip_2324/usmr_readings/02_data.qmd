...
- If you clear your environment, restart R, and run your script all at once (see [Chapter 1: Good Habits](01_R.html#Good_Habits)), it shouldn't produce errors and should get you back to your current place  
...
Thinking back to the previous chapter [when we first introduced R](01_R.html#R_is_a_calculator), we talked briefly about "logical operators". Specifically, the operators `&`, `|`, and `!` (for "and", "or"," and "not"), will come in handy now.  
