...
When we introduced simple linear regression, we talked about the assumptions that these models rely on (see [Chapter 10 #a-first-look-at-linear-model-assumptions](10_slr.html#a-first-look-at-linear-model-assumptions){target="_blank"}). 
...
We already saw how to interpret the plots in simple regression models ([Chapter 10 #first-look-assumptions](10_slr.html#a-first-look-at-linear-model-assumptions){target="_blank"}), and this doesn't change when we move to multiple regression models.  
