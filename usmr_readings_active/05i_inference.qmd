...
stroopdata <- read.csv("https://uoepsy.github.io/data/stroop.csv")
```

<small style="display:block;text-align:right">You are viewing an interactive version of this reading.<br>Please allow ~30 seconds for packages to load before code chunks can be run<br><a class="intlink" href="../readings/05_inference.html">Click here for the static version</a></small>
...
We saw previously [(Chapter 4)](04_sampling.html) how to make a __confidence interval__ as a means of capturing this uncertainty, providing a range of plausible values. 
...
\end{align}
$$
The 1.96 used here comes from our rules-of-thumb about the normal distribution (see [Chapter 4 #normal-distributions](04_sampling.html#normal-distributions){target="_blank"}): 95% of the data fall within 1.96 standard deviations of the mean:^[
