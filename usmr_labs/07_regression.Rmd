...
:::int
The model *with* weekly the weekly number of social interactions as a predictor explains `r round(summary(model2)$adj.r.sq, 1)`\% of the variance, and the model *without* explains `r round(summary(model1)$adj.r.sq,1)`\%.  
:::
