...
There's a very subtle point here that the "confidence" we have is about our confidence in the _interval_, not in the population parameter (which is just some fixed number).   
