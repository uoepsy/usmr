...
# Intro to R and Rstudio, and data in R {#chap-intro}
...
`r optbegin("Option A: Installing R and Rstudio (recommended)",slabel=FALSE)`
...
`r optbegin("Option B: Rstudio Cloud (for chromebook users)",slabel=FALSE)`
