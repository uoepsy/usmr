...
`r qbegin("A1")`
Starting in the 2020/21 academic year, we ask students on all the statistics courses to complete a short survey during the welcome week. 
One of the questions concerns the month in which you were born. You can download the data from https://uoepsy.github.io/data/surveydata_allcourse.csv.  
