...
There was a section in reading [Chapter 1 #useful-settings](https://uoepsy.github.io/usmr/2526/readings/01_R.html#useful-settings){target="_blank"} that showed a couple of settings that are very useful. Please change these now.  
...
Anonymised data are available at [https://uoepsy.github.io/data/usmr25surveydata_historical.csv](https://uoepsy.github.io/data/usmr25surveydata_historical.csv).  
...
`data <- data |> mutate(...)`  
(see [Chapter 3 #advances-in-r](https://uoepsy.github.io/usmr/2526/readings/03_measurement.html#advances-in-r){target="_blank"})
...
- See also [Chapter 3 #categorical](https://uoepsy.github.io/usmr/2526/readings/03_measurement.html#categorical){target="_blank"}.  
...
- We're likely to have missing data in here, so `na.rm=TRUE` will be handy (see [Chapter 3 #numeric](https://uoepsy.github.io/usmr/2526/readings/03_measurement.html#numeric){target="_blank"})
...
::: {.callout-tip collapse="true"}
#### Hints  
if we want a histogram, then `hist()` won't cut it here, we're going to want to use **ggplot** to make a lovely pretty histogram, (ggplot was introduced in [Chapter 3 #ggplot](https://uoepsy.github.io/usmr/2526/readings/03_measurement.html#ggplot){target="_blank"}).  
:::
`r qend()`
`r solbegin(show=params$SHOW, toggle=params$TOGGLE)`
```{r}
...
::: {.callout-tip collapse="true"}
#### Hints  
You can do this with things like `mean(data$variable)`, or you can do it all in tidyverse (see the example of `summarise` in the intro to tidyverse: [Chapter 3 #advances-in-r](https://uoepsy.github.io/usmr/2526/readings/03_measurement.html#advances-in-r){target="_blank"}).  
...
- The previous question gives you all the pieces that you need. You'll just need to put them together in the way seen in [Chapter 4 #confidence-intervals](https://uoepsy.github.io/usmr/2526/readings/04_sampling.html#confidence-intervals){target="_blank"}.  
...
We can also avoid ever using the standard deviation of our sample (`sd(usmr2022on$sleeprating)`), and instead approximate the sampling distribution of the mean by "bootstrapping" - taking repeated _resamples_ with replacement from the original sample (see [Chapter 4 #standard-error](https://uoepsy.github.io/usmr/2526/readings/04_sampling.html#standard-error-in-practice){target="_blank"}.  
...
For 3, look up `quantile()`. We saw this in [Chapter 4 #confidence-intervals](https://uoepsy.github.io/usmr/2526/readings/04_sampling.html#confidence-intervals){target="_blank"}.  
