...
In contrary to what might be expected, change-blindness appeared to decrease with alcohol intoxication, with the odds of noticing the swap increasing `r res[3,1]` times for every 1/100th of a percentage increase in blood alcohol content ($[`r paste(res[3,2:3],collapse=", ")`]$), holding age and perceptual load constant. 
