...
We're wanting to test the influence of a _set_ of predictors here. Sounds like a job for model comparison! (see [Chapter 16 #comparing-models](https://uoepsy.github.io/usmr/2526/readings/16_glm.html#comparing-models){target="_blank"}).    
...
The interpretation of logistic regression coefficients is explained in [Chapter 16  #coefficient-interpretation](https://uoepsy.github.io/usmr/2526/readings/16_glm.html#coefficient-interpretation){target="_blank"}.  
...
Confidence intervals (CIs) are often used to make a statement about a null hypothesis _just like_ a p-value (see [Chapter 5 #inference](https://uoepsy.github.io/usmr/2526/readings/05_inference.html#null-hypothesis-significance-testing-nhst){target="_blank"}. If a 95% CI does not contain zero then we can, with that same level of confidence, reject the null hypothesis that the population value is zero. So a 95% confidence interval maps to $p<.05$, and a 99% CI maps to $p<.01$, and so on.  
...
There's an example of this at [Chapter 16 #visualising](https://uoepsy.github.io/usmr/2526/readings/16_glm.html#visualising){target="_blank"}. Using the __effects__ package will be handy.  
...
We already played with some marshmallow-related data in [Chapter 16](https://uoepsy.github.io/usmr/2526/readings/16_glm.html#fitting-glm-in-r){target="_blank"}. Here we are extending this study to investigate whether the visibility of the immediate reward moderates age effects on the ability to delay gratification (the ability to forgo an immediate reward for a greater reward at a later point).  
...
A template RMarkown file can be found at [here](https://uoepsy.github.io/usmr/2324/misc/marshmallows.Rmd){target="_blank"} if you want it. It contains a list of questions try and make sure you answer in your write-up.  
...
- See the optional box under logistic regression in [Chapter 16 #fitting-glm-in-r](https://uoepsy.github.io/usmr/2526/readings/16_glm.html#fitting-glm-in-r){target="_blank"} for how to fit a binomial model to data like this.   
...
- See these [lecture slides (from 2023)](https://uoepsy.github.io/usmr/2324/lectures/lecture09.html#/accuracy){target="_blank"} for an example of how we can get a number for "how accurately can my model predict".  
