...
In the model:  
$$
\text{Cognition} = b_0 + b_1 \cdot\text{air_poll} + b_2\cdot\text{APOE4+} + b_3\cdot\text{air_poll} \cdot \text{APOE4+}
$$
...
In the model
$$
\text{candy bars} = b_0 + b_1 \cdot\text{anonymity} + b_2\cdot\text{group} + b_3\cdot\text{anonymity} \cdot \text{group}
$$
