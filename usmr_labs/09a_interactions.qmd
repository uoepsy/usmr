...
We can make these sort of plots very easily using handy packages that are designed to make our lives easier. The _big_ downside is that when we reliance on these packages will a) make it harder to customise plots, b) make it harder to troubleshoot when things go wrong, and c) stop us frmo having to *think* (and thinking is always good!).  
...
When we have categorical predictors, and we are using the default contrasts coding in R, then our coefficients for the individual predictors represent moving along between the dots in the plots we can make.   
...
condition1            0.05141    0.08796   0.584     0.56    
grouping1            -1.36607    0.08796 -15.530  < 2e-16 ***
condition1:grouping1 -0.54066    0.08796  -6.146 1.15e-08 ***
---
```
