...
contcont <- tibble(
  x1 = rnorm(60),
  x2 = rnorm(60),
  y = 1*x1 + 2*x2 + .6*x1*x2 + rnorm(60),
  partner_time = round(5+(scale(x1)[,1]*3),2),
...
p <- persp(x1,x2,y, theta = 210,phi=20, col = NA,
           xlab="Time spent with partner",ylab="Relationship Quality",zlab="Wellbeing")
