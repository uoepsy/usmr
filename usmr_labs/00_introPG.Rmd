...
1. Login to the RStudio.ppls server, and get comfortable with the layout  
...
A) Use the RStudio.ppls server. This saves you time on installing stuff on your own PC as it means you can use R from within an internet browser. It *does* mean that you will require an internet connection whenever you want to use R.  
...
:::red
**If you encounter any problems during the installation of R or RStudio, please try to use the RStudio.ppls server (option A)**
:::
...
:::red
If you are using **rstudio.ppls.ed.ac.uk**, then we have already installed "tidyverse" and a few other useful packages for you, so you can skip this next question!  
:::
