...
This is the same logic as the air-pollution & APOE-4 example in [Chapter 15 #it-depends](https://uoepsy.github.io/usmr/2627/readings/15_interactions.html#it-depends){target="_blank"}.  
...
Our interaction involves a continuous variable (`hrs_sleep`) and a binary variable (`alc`). An interpretation of a similar example is in [Chapter 15 #interpretation](https://uoepsy.github.io/usmr/2627/readings/15_interactions.html#interpretation){target="_blank"}.  
...
If you get stuck, a very similar example is in [Chapter 15 #visualisation](https://uoepsy.github.io/usmr/2627/readings/15_interactions.html#visualisation){target="_blank"}.  
