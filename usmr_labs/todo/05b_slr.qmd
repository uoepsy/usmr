...
- Modelling and outcome variable as a linear function of an explanatory variable.   
...
\color{red}{y}\color{black} \qquad = \qquad & \color{blue}{b_0 + b_1 \ (x)}\color{black} & +\qquad \varepsilon \quad \\
\end{align}
$$
