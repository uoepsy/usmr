...
::: {.callout-tip collapse="true"}
#### Hints  
You can do this all with one function, see [Chapter 9 #correlation-test](https://uoepsy.github.io/usmr/2627/readings/09_covcor.html#correlation-tests){target="_blank"}.  
:::
...
To comment numerically on the strength of the linear association we might compute the correlation coefficient that we were introduced to in [Chapter 9: Covariance & Correlation](https://uoepsy.github.io/usmr/2627/readings/09_covcor.html)
```{r}
monkeyexp |>
...
::: {.callout-tip collapse="true"}
#### Hints
You can see how to fit linear models in R using `lm()` in [Chapter 10 #fitting-linear-models-in-r](https://uoepsy.github.io/usmr/2627/readings/10_slr.html#fitting-linear-models-in-r){target="_blank"}
:::
...
::: {.callout-tip collapse="true"}
#### Hints
We saw how to extract lots of information on our model using `summary()` (see [Chapter 10 #model-summary](https://uoepsy.github.io/usmr/2627/readings/10_slr.html#model-summary){target="_blank"}), but there are lots of other functions too.  
...
See [Chapter 10 #inference-for-regression-coefficients](https://uoepsy.github.io/usmr/2627/readings/10_slr.html#inference-for-regression-coefficients){target="_blank"}.
:::
...
<!-- - See [Ch 10 #r2](https://uoepsy.github.io/usmr/2627/readings/10_slr.html#r2){target="_blank"} if you're unsure about what $R^2$ is.     -->
...
<!-- ::: {.callout-tip collapse="true"} -->
<!-- #### Hints -->
<!-- [Ch 10#the-f-statistic](https://uoepsy.github.io/usmr/2627/readings/10_slr.html#the-f-statistic){target="_blank"} will help.   -->
<!-- ::: -->
...
::: {.callout-tip collapse="true"}
#### Hints
For our simple regression model, there is a really easy way to do this with `geom_smooth()`.  Check [Chapter 10 #example](https://uoepsy.github.io/usmr/2627/readings/10_slr.html#example){target="_blank"}, which shows an example.
:::
...
::: {.callout-tip collapse="true"}
#### Hints
See [Chapter 10 #the-error](https://uoepsy.github.io/usmr/2627/readings/10_slr.html#the-error){target="_blank"}.
:::
...
::: {.callout-tip collapse="true"}
#### Hints
Given that you know the intercept and slope, you can calculate this algebraically. However, try to also use the `predict()` function (see [Chapter 10 #model-predictions](https://uoepsy.github.io/usmr/2627/readings/10_slr.html#model-predictions){target="_blank}). 
:::
...
`r qbegin(qcounter())`
Take a look at the assumption plots (see [Chapter 10 #assumptions](https://uoepsy.github.io/usmr/2627/readings/10_slr.html#assumptions){target="_blank"}) for your model.  
...
::: {.callout-tip collapse="true"}
#### Hints
For help interpreting the coefficients, see [Chapter 10 #binary-predictors](https://uoepsy.github.io/usmr/2627/readings/10_slr.html#binary-predictors){target="_blank"}.  
:::
...
The data from this year's survey that you filled out in the first couple of weeks is available at [https://uoepsy.github.io/data/usmr2026.csv](https://uoepsy.github.io/data/usmr2026.csv)  

- **Step 1:** Using the USMR 2026 survey data, make *either* the prettiest plot you can or the ugliest plot you can . 
...
All plots submitted by end-of-day on 30th October will be rated by a number of non-USMR staff, and prizes made of chocolate will be awarded to the team with the prettiest plot and to the team with the ugliest plot. 
