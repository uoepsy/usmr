...
1. Open Rstudio, make sure you have the USMR project open, and create a new R Script (giving it a title for this week). 
...
Recall that we saw this idea last week briefly, when we talked about a uniform distribution:
