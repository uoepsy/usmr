...
`r qbegin(1)` 
Create a new heading for these exercises and read in the data.  
`r qend()`
`r solbegin(1, show=params$SHOW_SOLS, toggle=params$TOGGLE)`
```{r include=FALSE}
...
`r qend()`
`r solbegin(7, show=params$SHOW_SOLS, toggle=params$TOGGLE)`
