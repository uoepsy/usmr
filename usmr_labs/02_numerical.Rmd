...
This idea may be familiar - think about what this looks like when there is an equal probability assigned to each value - it's not a curve but is flat, and is known as the __uniform distribution__:
