...
The data is available at https://uoepsy.github.io/data/pass_scores.csv.  
:::
...
`r qbegin("A3")`
Conduct a one sample $t$-test to evaluate whether the average height of students of USMR 2020/2021 is different from 155cm.  

The data is available at https://uoepsy.github.io/usmr/surveyresults/usmr_surveyresponse.csv. 
`r qend()`
`r solbegin(show=params$SHOW_SOLS, toggle=params$TOGGLE)`
```{r}
...
t.test(survey_data$height, mu = 155, alternative = "two.sided")
```
`r solend()`
...
The data is available at https://uoepsy.github.io/data/gerritysim.csv.  
