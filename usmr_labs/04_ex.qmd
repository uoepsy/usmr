...
(If you're wondering how we do this in R, there's a complicated bit of code using `%o%` which could do this for us. You don't need to remember %o%, it's very rarely used): 
```{r}
t <- tipjoke %>%
