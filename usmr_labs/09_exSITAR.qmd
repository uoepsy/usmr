...
Note - from our coefficients we always have to answer a question like this by starting with a reference point (i.e. capuchins with soft toys). We can change what this reference is though, if we want to.  
