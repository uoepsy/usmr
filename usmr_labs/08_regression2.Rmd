...
we can standardise our variables, and change what "1 unit" means.. 


# categorical predictors
we talked briefly about a binary predictor last week. 
include plot of data, and plot of model (x axis becomes numeric). 

we can have these in multiple regression. 
what was a regression surface last week, is now more like two lines. 
## ~ Numeric + Categorical
