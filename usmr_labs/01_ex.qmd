...
:::column-margin
Our recommendation is that you have an R project for this course, and use a new script for each week of work. See [the tip about "R projects" in Chapter 1](https://uoepsy.github.io/usmr/2526/readings/01_R.html#the-four-rstudio-panes){target="_blank"}.  
:::
...
[Chapter 2 #basic-data-wrangling](https://uoepsy.github.io/usmr/2526/readings/02_data.html#basic-data-wrangling){target="_blank"} contains an example of reading in data from a URL. 
...
::: {.callout-tip collapse="true"}
#### Hints
You'll want to think about how we access data via asking for those entries that meet a specific _condition_ (see [Chapter 2 #accessing-by-a-condition](https://uoepsy.github.io/usmr/2526/readings/02_data.html#accessing-by-a-condition){target="_blank"})  
:::
`r qend()`
`r solbegin(show=params$SHOW, toggle=params$TOGGLE)`
...
::: {.callout-tip collapse="true"}
#### Hints
This is a slightly complex one. [Chapter 2 #more-complex-conditions](https://uoepsy.github.io/usmr/2526/readings/02_data.html#more-complex-conditions){target="_blank"} might help you here.  
:::
`r qend()`
`r solbegin(show=params$SHOW, toggle=params$TOGGLE)`
...
::: {.callout-tip collapse="true"}
#### Hints
Try looking up the help documentation for the function `round()`. Try playing with it in the console, e.g. `round(c(3.5, 4.257, 1.1111))`. You may find it helpful to look back at [Chapter 2 #adding/changing-a-variable](https://uoepsy.github.io/usmr/2526/readings/02_data.html#addingchanging-a-variable){target="_blank"}.  
