...
`qnorm`!  (see the end of [Chapter 5 #uncertainty-due-to-sampling](https://uoepsy.github.io/usmr/2526/readings/05_inference.html#uncertainty-due-to-sampling){target="_blank"})
...
`r qbegin(qcounter())`
As we learned in [Chapter 6 #t-distributions](https://uoepsy.github.io/usmr/2526/readings/06_inference2.html#t---distributions){target="_blank"}, the sampling distribution of a statistic has heavier tails the smaller the size of the sample it is derived from. In practice, we are better using $t$-distributions to construct confidence intervals and perform statistical tests.  
...
- you can see the step-by-step calculation of a one sample t-test in [Chapter 6 #one-sample-t-test](https://uoepsy.github.io/usmr/2526/readings/06_inference2.html#one-sample-t-test){target="_blank"}. 
...
::: {.callout-tip collapse="true"}
#### Hints  
There are some quick example write-ups for each test in [Chapter 6 #basic-tests](https://uoepsy.github.io/usmr/2526/readings/06_inference2.html#basic-tests){target="_blank"}
:::
`r qend()`
`r solbegin(show=params$SHOW_SOLS, toggle=params$TOGGLE)`
```{r include=FALSE}
...
We can again use the data from the past surveys: [https://uoepsy.github.io/data/usmr25survey_historical.csv](https://uoepsy.github.io/data/usmr25survey_historical.csv)  
