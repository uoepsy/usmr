...
t.test(weight_kg ~ species, pets[pets$species != "Goat", ])
...
```{r}
cbt <- read.csv("https://uoepsy.github.io/data/dapr1_2122_report_data.csv")

cbt <- cbt %>% mutate(reduction = anx_t1 - anx_t2)
```
