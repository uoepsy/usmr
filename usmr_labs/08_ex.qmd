...
`r qbegin(qcounter())`
Fit a model examining whether belief of the research article differs between conditions.  
`r qend()`
`r solbegin(show=params$SHOW_SOLS, toggle=params$TOGGLE)`
...
Can you add the data to the plot, to present a better picture?  
...
`r qbegin(qcounter())`
Fit a model to examine the independent associations between job satisfaction and all of these aspects of work life.  
