...
But this info is also at the bottom of the summary, because we just have one predictor in the model
```{r}
#| eval: false
summary(mod1)
```
...
Then the coefficients are telling us *how* the conditons differ:
