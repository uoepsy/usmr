...
::: {.callout-tip collapse="true"}
#### Hints
For our simple regression model, there is a really easy way to do this with `geom_smooth()`.  Check [5B #example](05b_slr.html#example){target="_blank"}, which shows an example.
:::
